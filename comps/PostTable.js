...
>Delete Post</a> | <Link href={obj.post_type=='news' ? `https://ar.katib.in/news/${obj.post_link}` : `https://ar.katib.in/${obj.post_link}`} legacyBehavior><a target="_blank">View Post</a></Link>
</div>}
